...
inline void subplot(long nrows, long ncols, long plot_number)
{
    ...
    // Check if the subplot function is available
    if (!detail::_interpreter::get().s_python_function_subplot) {
        std::cerr << "Error: subplot function not available." << std::endl;
        throw std::runtime_error("subplot function not available.");
    }
